...
#define DG_START_LATIN 0xa1
        ...
        {'E', ':', 0xcb},
        {'E', '"', 0xcb}, // À Vim 5.x compatible
        {'I', '!', 0xcc},
        {'I', '`', 0xcc}, // Ã Vim 5.x compatible
        {'I', '\'', 0xcd},
        {'I', '>', 0xce},
        {'I', '^', 0xce}, // Œ Vim 5.x compatible
        {'I', ':', 0xcf},
        {'I', '"', 0xcf}, // œ Vim 5.x compatible
        {'D', '-', 0xd0},
        {'N', '?', 0xd1},
        ...
        {'a', 'a', 0xe5},
        {'a', '@', 0xe5}, // Â Vim 5.x compatible
        {'a', 'e', 0xe6},
        {'c', ',', 0xe7},
        {'e', '!', 0xe8},
        {'e', '`', 0xe8}, // Ë Vim 5.x compatible
        {'e', '\'', 0xe9},
        {'e', '>', 0xea},
        {'e', '^', 0xea}, // Í Vim 5.x compatible
        {'e', ':', 0xeb},
        {'e', '"', 0xeb}, // Î Vim 5.x compatible
        {'i', '!', 0xec},
        {'i', '`', 0xec}, // Ï Vim 5.x compatible
        {'i', '\'', 0xed},
        {'i', '>', 0xee},
        {'i', '^', 0xee}, // Ó Vim 5.x compatible
        {'i', ':', 0xef},
        {'d', '-', 0xf0},
        {'n', '?', 0xf1},
        {'n', '~', 0xf1}, // Ò Vim 5.x compatible
        {'o', '!', 0xf2},
        {'o', '`', 0xf2}, // Ú Vim 5.x compatible
        {'o', '\'', 0xf3},
        {'o', '>', 0xf4},
        {'o', '^', 0xf4}, // Ù Vim 5.x compatible
        {'o', '?', 0xf5},
        {'o', '~', 0xf5}, // ı Vim 5.x compatible
        {'o', ':', 0xf6},
        {'-', ':', 0xf7},
        {'o', '/', 0xf8},
        {'u', '!', 0xf9},
...
void listdigraphs(int use_headers)
{
  ...
  for (i = 0; dp->char1 != NUL && !got_int; ++i)
  {
    ...
    if (getexactdigraph(dp->char1, dp->char2, FALSE) == dp->result && (has_mbyte || dp->result <= 255))
...
#define KMAP_LLEN 200 /* max length of "to" and "from" together */
  ...
  for (;;)
  {
    ...
    if (*p != '"' && *p != NUL && ga_grow(&curbuf->b_kmap_ga, 1) == OK)
    {
      ...
      if (kp->from == NULL || kp->to == NULL || STRLEN(kp->from) + STRLEN(kp->to) >= KMAP_LLEN || *kp->from == NUL || *kp->to == NUL)
      {
