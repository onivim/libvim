...
static int nfa_classcodes[] = {NFA_ANY,    NFA_IDENT, NFA_SIDENT, NFA_KWORD, NFA_SKWORD, NFA_FNAME,
...
#define y_diaeresis 0xff
    ...
    case 'L':
      CASEMBC(0x139)
      CASEMBC(0x13b)
      CASEMBC(0x13d) CASEMBC(0x13f) CASEMBC(0x141) CASEMBC(0x1e3a) EMIT2('L');
      EMITMBC(0x139)
      EMITMBC(0x13b)
      EMITMBC(0x13d) EMITMBC(0x13f) EMITMBC(0x141) EMITMBC(0x1e3a) return OK;
    ...
    case U_circumflex:
      ...
      CASEMBC(0x16e)
      CASEMBC(0x170)
      CASEMBC(0x172) CASEMBC(0x1af) CASEMBC(0x1d3) CASEMBC(0x1ee6) EMIT2('U');
      EMIT2(U_grave);
      EMIT2(U_acute);
      EMIT2(U_diaeresis);
      EMIT2(U_circumflex);
      ...
      EMITMBC(0x16e)
      EMITMBC(0x170)
      EMITMBC(0x172) EMITMBC(0x1af) EMITMBC(0x1d3) EMITMBC(0x1ee6) return OK;
    ...
    case 'W':
      CASEMBC(0x174)
      CASEMBC(0x1e80)
      CASEMBC(0x1e82) CASEMBC(0x1e84) CASEMBC(0x1e86) EMIT2('W');
      EMITMBC(0x174)
    ...
    case Y_acute:
      ...
      EMITMBC(0x176)
      EMITMBC(0x178)
      EMITMBC(0x1e8e) EMITMBC(0x1ef2) EMITMBC(0x1ef6) EMITMBC(0x1ef8) return OK;

    case 'Z':
      CASEMBC(0x179)
      CASEMBC(0x17b)
      CASEMBC(0x17d) CASEMBC(0x1b5) CASEMBC(0x1e90) CASEMBC(0x1e94) EMIT2('Z');
      EMITMBC(0x179)
      EMITMBC(0x17b)
      EMITMBC(0x17d) EMITMBC(0x1b5) EMITMBC(0x1e90) EMITMBC(0x1e94) return OK;
    ...
    case i_diaeresis:
      CASEMBC(0x129)
      CASEMBC(0x12b)
      CASEMBC(0x12d) CASEMBC(0x12f) CASEMBC(0x1d0) CASEMBC(0x1ec9) EMIT2('i');
      EMIT2(i_grave);
      EMIT2(i_acute);
      EMIT2(i_circumflex);
      EMIT2(i_diaeresis);
      EMITMBC(0x129)
      EMITMBC(0x12b)
      EMITMBC(0x12d) EMITMBC(0x12f) EMITMBC(0x1d0) EMITMBC(0x1ec9) return OK;
    ...
    case 'l':
      CASEMBC(0x13a)
      CASEMBC(0x13c)
      CASEMBC(0x13e) CASEMBC(0x140) CASEMBC(0x142) CASEMBC(0x1e3b) EMIT2('l');
      EMITMBC(0x13a)
      EMITMBC(0x13c)
      EMITMBC(0x13e) EMITMBC(0x140) EMITMBC(0x142) EMITMBC(0x1e3b) return OK;
    ...
    case n_virguilla:
      CASEMBC(0x144)
      CASEMBC(0x146)
      CASEMBC(0x148) CASEMBC(0x149) CASEMBC(0x1e45) CASEMBC(0x1e49) EMIT2('n');
      EMIT2(n_virguilla);
      EMITMBC(0x144)
      EMITMBC(0x146)
      EMITMBC(0x148) EMITMBC(0x149) EMITMBC(0x1e45) EMITMBC(0x1e49) return OK;
    ...
    case 't':
      CASEMBC(0x163)
      CASEMBC(0x165)
      CASEMBC(0x167) CASEMBC(0x1e6b) CASEMBC(0x1e6f) CASEMBC(0x1e97) EMIT2('t');
      EMITMBC(0x163)
      EMITMBC(0x165)
      EMITMBC(0x167) EMITMBC(0x1e6b) EMITMBC(0x1e6f) EMITMBC(0x1e97) return OK;
    ...
    case u_diaeresis:
      ...
      CASEMBC(0x16f)
      CASEMBC(0x171)
      CASEMBC(0x173) CASEMBC(0x1b0) CASEMBC(0x1d4) CASEMBC(0x1ee7) EMIT2('u');
      EMIT2(u_grave);
      EMIT2(u_acute);
      EMIT2(u_circumflex);
      EMIT2(u_diaeresis);
      ...
      EMITMBC(0x16f)
      EMITMBC(0x171)
      EMITMBC(0x173) EMITMBC(0x1b0) EMITMBC(0x1d4) EMITMBC(0x1ee7) return OK;
    ...
    case y_diaeresis:
      ...
      CASEMBC(0x1e8f)
      CASEMBC(0x1e99)
      CASEMBC(0x1ef3) CASEMBC(0x1ef7) CASEMBC(0x1ef9) EMIT2('y');
      EMIT2(y_acute);
      EMIT2(y_diaeresis);
      EMITMBC(0x177)
      EMITMBC(0x1e8f)
    ...
    case 'z':
      CASEMBC(0x17a)
      CASEMBC(0x17c)
      CASEMBC(0x17e) CASEMBC(0x1b6) CASEMBC(0x1e91) CASEMBC(0x1e95) EMIT2('z');
      EMITMBC(0x17a)
      EMITMBC(0x17c)
      EMITMBC(0x17e) EMITMBC(0x1b6) EMITMBC(0x1e91) EMITMBC(0x1e95) return OK;
...
static int nfa_regatom(void) {
  ...
  nfa_do_multibyte:
    ...
    if (enc_utf8 &&
        ((*mb_char2len)(c) != (plen = utfc_ptr2len(old_regparse)) || utf_iscomposing(c))) {
      int i = 0;
...
static void nfa_postprocess(nfa_regprog_T *prog) {
  ...
  for (i = 0; i < prog->nstate; ++i) {
    ...
    if (c == NFA_START_INVISIBLE || c == NFA_START_INVISIBLE_NEG ||
        c == NFA_START_INVISIBLE_BEFORE || c == NFA_START_INVISIBLE_BEFORE_NEG) {
      int directly;
...
static void clear_sub(regsub_T *sub) {
  if (REG_MULTI)
    ...
    vim_memset(sub->list.multi, 0xff, sizeof(struct multipos) * rex.nfa_nsubexpr);
  else
 ...
 */
static int nfa_regmatch(nfa_regprog_T *prog, nfa_state_T *start, regsubs_T *submatch,
                        regsubs_T *m) {
  int result = FALSE;
  size_t size = 0;
  int flag = 0;
  ...
  for (;;) {
    ...
    for (listidx = 0; listidx < thislist->n; ++listidx) {
      ...
      case NFA_END_PATTERN:
         ...
         * "nfa_endp" */
        if (nfa_endp != NULL && (REG_MULTI ? (rex.lnum != nfa_endp->se_u.pos.lnum ||
            ...
            if (rex.reg_ic) {
              ...
              if (done)
                break;
                                  ...
                                  : (curc == state->c ||
                                     (rex.reg_ic && MB_TOLOWER(curc) == MB_TOLOWER(state->c)))) {
            result = result_if_matched;
            break;
          }
          state = state->out;
      ...
      case NFA_LNUM_GT:
      case NFA_LNUM_LT:
        result = (REG_MULTI && nfa_re_num_cmp(t->state->val, t->state->c - NFA_LNUM,
      ...
      case NFA_VCOL_LT: {
        ...
        if (!result)
          result =
              nfa_re_num_cmp(t->state->val, op, (long_u)win_linetabsize(wp, rex.line, col) + 1);
        if (result) {
          add_here = TRUE;
          add_state = t->state->out;
        }
      ...
      case NFA_CURSOR:
        result =
            (rex.reg_win != NULL && (rex.lnum + rex.reg_firstlnum == rex.reg_win->w_cursor.lnum) &&
 ...
 * Returns <= 0 for failure, number of lines contained in the match otherwise.
 */
static long nfa_regexec_both(char_u *line, colnr_T startcol, /* column to start looking for match */
 ...
 */
static long nfa_regexec_multi(regmmatch_T *rmp, win_T *win, /* window in which to search or NULL */
