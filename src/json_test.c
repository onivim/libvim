 ...
 */
static void test_decode_find_end(void) {
  js_read_T reader;
...
static int fill_from_cookie(js_read_T *reader) {
 ...
 */
static void test_fill_called_on_find_end(void) {
  js_read_T reader;
 ...
 */
static void test_fill_called_on_string(void) {
  js_read_T reader;
