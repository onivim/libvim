...
#define P_ONECOMMA 0x18000L /* P_COMMA and cannot have two consecutive         \  \ \ commas */
...
#define P_PRI_MKRC                                                                                 \
  0x1000000L /* priority for :mkvimrc (setting option has        \ \ side \ \ \ effects) */
#define P_NO_ML 0x2000000L /* not allowed in modeline */
#define P_CURSWANT                                                                                 \
  0x4000000L /* update curswant required; not needed when    \  \ \ \ \ there is a redraw flag */
...
#define HIGHLIGHT_INIT                                                                             \
  "8:SpecialKey,~:EndOfBuffer,@:NonText,d:Directory,e:ErrorMsg,i:IncSearch,l:"                     \
  "Search,m:MoreMsg,M:ModeMsg,n:LineNr,N:CursorLineNr,r:Question,s:"                               \
  "StatusLine,S:StatusLineNC,c:VertSplit,t:Title,v:Visual,V:VisualNOS,w:"                          \
  "WarningMsg,W:WildMenu,f:Folded,F:FoldColumn,A:DiffAdd,C:DiffChange,D:"                          \
  "DiffDelete,T:DiffText,>:SignColumn,-:Conceal,B:SpellBad,P:SpellCap,R:"                          \
  "SpellRare,L:SpellLocal,+:Pmenu,=:PmenuSel,x:PmenuSbar,X:PmenuThumb,*:"                          \
  "TabLine,#:TabLineSel,_:TabLineFill,!:CursorColumn,.:CursorLine,o:"                              \
  "ColorColumn,q:QuickFixLine,z:StatusLineTerm,Z:StatusLineTermNC"
...
static struct vimoption options[] = {
    ...
    {"arabic",
     "arab",
     P_BOOL | P_VI_DEF | P_VIM | P_CURSWANT,
#ifdef FEAT_ARABIC
     (char_u *)VAR_WIN,
     PV_ARAB,
#else
    ...
    {"ambiwidth",
     "ambw",
     P_STRING | P_VI_DEF | P_RCLR,
     (char_u *)&p_ambw,
     PV_NONE,
     {(char_u *)"single", (char_u *)0L} SCTX_INIT},
    {"autochdir",
     "acd",
     P_BOOL | P_VI_DEF,
    ...
    {"backspace",
     "bs",
     P_STRING | P_VI_DEF | P_VIM | P_ONECOMMA | P_NODUP,
     (char_u *)&p_bs,
     PV_NONE,
    ...
    {"backupcopy",
     "bkc",
     P_STRING | P_VIM | P_ONECOMMA | P_NODUP,
     (char_u *)&p_bkc,
     PV_BKC,
#ifdef UNIX
    ...
    {"backupdir",
     "bdir",
     P_STRING | P_EXPAND | P_VI_DEF | P_ONECOMMA | P_NODUP | P_SECURE,
     (char_u *)&p_bdir,
     PV_NONE,
     {(char_u *)DFLT_BDIR, (char_u *)0L} SCTX_INIT},
    {"backupext",
     "bex",
     P_STRING | P_VI_DEF | P_NFNAME,
     (char_u *)&p_bex,
     PV_NONE,
     {
#ifdef VMS
    ...
    {"balloonexpr",
     "bexpr",
     P_STRING | P_ALLOCED | P_VI_DEF | P_VIM | P_MLE,
#if defined(FEAT_BEVAL) && defined(FEAT_EVAL)
     (char_u *)&p_bexpr,
     PV_BEXPR,
     {(char_u *)"", (char_u *)0L}
    ...
    {"belloff",
     "bo",
     P_STRING | P_VI_DEF | P_COMMA | P_NODUP,
     (char_u *)&p_bo,
     PV_NONE,
     {(char_u *)"", (char_u *)0L} SCTX_INIT},
    {"binary",
     "bin",
     P_BOOL | P_VI_DEF | P_RSTAT,
     (char_u *)&p_bin,
     PV_BIN,
     {(char_u *)FALSE, (char_u *)0L} SCTX_INIT},
    {"bioskey",
    ...
    {"bomb",
     NULL,
     P_BOOL | P_NO_MKRC | P_VI_DEF | P_RSTAT,
     (char_u *)&p_bomb,
     PV_BOMB,
     {(char_u *)FALSE, (char_u *)0L} SCTX_INIT},
    {"breakat",
     "brk",
     P_STRING | P_VI_DEF | P_RALL | P_FLAGLIST,
#ifdef FEAT_LINEBREAK
     (char_u *)&p_breakat,
     PV_NONE,
     {(char_u *)" \t!@*-+;:,./?", (char_u *)0L}
    ...
    {"breakindentopt",
     "briopt",
     P_STRING | P_ALLOCED | P_VI_DEF | P_RBUF | P_ONECOMMA | P_NODUP,
#ifdef FEAT_LINEBREAK
     (char_u *)VAR_WIN,
     PV_BRIOPT,
     {(char_u *)"", (char_u *)NULL}
    ...
    {"bufhidden",
     "bh",
     P_STRING | P_ALLOCED | P_VI_DEF | P_NOGLOB,
     (char_u *)&p_bh,
     PV_BH,
     {(char_u *)"", (char_u *)0L} SCTX_INIT},
    {"buflisted",
     "bl",
     P_BOOL | P_VI_DEF | P_NOGLOB,
     (char_u *)&p_bl,
     PV_BL,
    ...
    {"casemap",
     "cmp",
     P_STRING | P_VI_DEF | P_ONECOMMA | P_NODUP,
     (char_u *)&p_cmp,
     PV_NONE,
     {(char_u *)"internal,keepascii", (char_u *)0L} SCTX_INIT},
    {"cdpath",
     "cd",
    ...
    {"colorcolumn",
     "cc",
     P_STRING | P_VI_DEF | P_ONECOMMA | P_NODUP | P_RWIN,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)"", (char_u *)0L} SCTX_INIT},
    {"columns",
    ...
    {"comments",
     "com",
     P_STRING | P_ALLOCED | P_VI_DEF | P_ONECOMMA | P_NODUP | P_CURSWANT,
#ifdef FEAT_COMMENTS
     (char_u *)&p_com,
     PV_COM,
    ...
    {"commentstring",
     "cms",
     P_STRING | P_ALLOCED | P_VI_DEF | P_CURSWANT,
#ifdef FEAT_FOLDING
     (char_u *)&p_cms,
     PV_CMS,
     {(char_u *)"/*%s*/", (char_u *)0L}
    ...
    {"concealcursor",
     "cocu",
     P_STRING | P_ALLOCED | P_RWIN | P_VI_DEF,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)NULL, (char_u *)0L} SCTX_INIT},
    {"conceallevel",
     "cole",
     P_NUM | P_RWIN | P_VI_DEF,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"completefunc",
     "cfu",
     P_STRING | P_ALLOCED | P_VI_DEF | P_SECURE,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"completeopt",
    ...
    {"cpoptions",
     "cpo",
     P_STRING | P_VIM | P_RALL | P_FLAGLIST,
     (char_u *)&p_cpo,
     PV_NONE,
     {(char_u *)CPO_VI, (char_u *)CPO_VIM} SCTX_INIT},
    {"cryptmethod",
     "cm",
     P_STRING | P_ALLOCED | P_VI_DEF,
#ifdef FEAT_CRYPT
     (char_u *)&p_cm,
     PV_CM,
    ...
    {"cscopepathcomp",
     "cspc",
     P_NUM | P_VI_DEF | P_VIM,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"cscopeprg",
     "csprg",
     P_STRING | P_EXPAND | P_VI_DEF | P_SECURE,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"cscopequickfix",
    ...
    {"diff",
     NULL,
     P_BOOL | P_VI_DEF | P_RWIN | P_NOGLOB,
#ifdef FEAT_DIFF
     (char_u *)VAR_WIN,
     PV_DIFF,
#else
    ...
    {"diffexpr",
     "dex",
     P_STRING | P_VI_DEF | P_SECURE | P_CURSWANT,
    ...
    {"diffopt",
     "dip",
     P_STRING | P_ALLOCED | P_VI_DEF | P_RWIN | P_ONECOMMA | P_NODUP,
#ifdef FEAT_DIFF
     (char_u *)&p_dip,
     PV_NONE,
    ...
    {"emoji",
     "emo",
     P_BOOL | P_VI_DEF | P_RCLR,
     (char_u *)&p_emoji,
     PV_NONE,
     {(char_u *)TRUE, (char_u *)0L} SCTX_INIT},
    {"encoding",
     "enc",
     P_STRING | P_VI_DEF | P_RCLR | P_NO_ML,
     (char_u *)&p_enc,
     PV_NONE,
     {(char_u *)ENC_DFLT, (char_u *)0L} SCTX_INIT},
    {"endofline",
     "eol",
     P_BOOL | P_NO_MKRC | P_VI_DEF | P_RSTAT,
     (char_u *)&p_eol,
    ...
    {"exrc",
     "ex",
     P_BOOL | P_VI_DEF | P_SECURE,
     (char_u *)&p_exrc,
     PV_NONE,
     {(char_u *)FALSE, (char_u *)0L} SCTX_INIT},
    {"fileencoding",
     "fenc",
     P_STRING | P_ALLOCED | P_VI_DEF | P_RSTAT | P_RBUF | P_NO_MKRC,
     (char_u *)&p_fenc,
     PV_FENC,
     {(char_u *)"", (char_u *)0L} SCTX_INIT},
    {"fileencodings",
     ...
     (char_u *)&p_fencs,
     PV_NONE,
     {(char_u *)"ucs-bom", (char_u *)0L} SCTX_INIT},
    {"fileformat",
     "ff",
     P_STRING | P_ALLOCED | P_VI_DEF | P_RSTAT | P_NO_MKRC | P_CURSWANT,
     (char_u *)&p_ff,
     PV_FF,
    ...
    {"fileformats",
     ...
     (char_u *)&p_ffs,
     PV_NONE,
     {(char_u *)DFLT_FFS_VI, (char_u *)DFLT_FFS_VIM} SCTX_INIT},
    {"fileignorecase",
     "fic",
     P_BOOL | P_VI_DEF,
     (char_u *)&p_fic,
    ...
    {"fillchars",
     "fcs",
     P_STRING | P_VI_DEF | P_RALL | P_ONECOMMA | P_NODUP,
     (char_u *)&p_fcs,
     PV_NONE,
     {(char_u *)"vert:|,fold:-", (char_u *)0L} SCTX_INIT},
    {"fixendofline",
     "fixeol",
     P_BOOL | P_VI_DEF | P_RSTAT,
     (char_u *)&p_fixeol,
    ...
    {"foldexpr",
     "fde",
     P_STRING | P_ALLOCED | P_VIM | P_VI_DEF | P_RWIN | P_MLE,
    ...
    {"foldignore",
     "fdi",
     P_STRING | P_ALLOCED | P_VIM | P_VI_DEF | P_RWIN,
#ifdef FEAT_FOLDING
     (char_u *)VAR_WIN,
     PV_FDI,
     {(char_u *)"#", (char_u *)NULL}
    ...
    {"foldmarker",
     "fmr",
     P_STRING | P_ALLOCED | P_VIM | P_VI_DEF | P_RWIN | P_ONECOMMA | P_NODUP,
#ifdef FEAT_FOLDING
     (char_u *)VAR_WIN,
     PV_FMR,
     {(char_u *)"{{{,}}}", (char_u *)NULL}
    ...
    {"foldopen",
     "fdo",
     P_STRING | P_VI_DEF | P_ONECOMMA | P_NODUP | P_CURSWANT,
#ifdef FEAT_FOLDING
     (char_u *)&p_fdo,
     PV_NONE,
    ...
    {"formatoptions",
     "fo",
     P_STRING | P_ALLOCED | P_VIM | P_FLAGLIST,
     (char_u *)&p_fo,
     PV_FO,
     {(char_u *)DFLT_FO_VI, (char_u *)DFLT_FO_VIM} SCTX_INIT},
    {"formatlistpat",
     "flp",
     P_STRING | P_ALLOCED | P_VI_DEF,
     (char_u *)&p_flp,
     PV_FLP,
     {(char_u *)"^\\s*\\d\\+[\\]:.)}\\t ]\\s*", (char_u *)0L} SCTX_INIT},
    {"formatprg",
     "fp",
     P_STRING | P_EXPAND | P_VI_DEF | P_SECURE,
     (char_u *)&p_fp,
    ...
    {"guifont",
     "gfn",
     P_STRING | P_VI_DEF | P_RCLR | P_ONECOMMA | P_NODUP,
#ifdef FEAT_GUI
     (char_u *)&p_guifont,
     PV_NONE,
     {(char_u *)"", (char_u *)0L}
    ...
    {"guifontset",
     "gfs",
     P_STRING | P_VI_DEF | P_RCLR | P_ONECOMMA,
    ...
    {"guitablabel",
     "gtl",
     P_STRING | P_VI_DEF | P_RWIN | P_MLE,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)NULL, (char_u *)0L} SCTX_INIT},
    {"guitabtooltip",
     "gtt",
     P_STRING | P_VI_DEF | P_RWIN,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)NULL, (char_u *)0L} SCTX_INIT},
    {"hardtabs",
    ...
    {"helpfile",
     ...
     (char_u *)&p_hf,
     PV_NONE,
     {(char_u *)DFLT_HELPFILE, (char_u *)0L} SCTX_INIT},
    {"helpheight",
     "hh",
     P_NUM | P_VI_DEF,
     (char_u *)&p_hh,
    ...
    {"highlight",
     ...
     (char_u *)&p_hl,
     PV_NONE,
     {(char_u *)HIGHLIGHT_INIT, (char_u *)0L} SCTX_INIT},
    {"history",
     "hi",
     P_NUM | P_VIM,
     (char_u *)&p_hi,
    ...
    {"iminsert",
     ...
     (char_u *)&p_iminsert,
     PV_IMI,
     {(char_u *)B_IMODE_NONE, (char_u *)0L} SCTX_INIT},
    {"imsearch",
     "ims",
     P_NUM | P_VI_DEF,
     (char_u *)&p_imsearch,
     PV_IMS,
     {(char_u *)B_IMODE_USE_INSERT, (char_u *)0L} SCTX_INIT},
    {"imstatusfunc",
     "imsf",
     P_STRING | P_VI_DEF | P_SECURE,
#if defined(FEAT_EVAL)
    ...
    {"includeexpr",
     "inex",
     P_STRING | P_ALLOCED | P_VI_DEF | P_MLE,
#if defined(FEAT_FIND_ID) && defined(FEAT_EVAL)
     (char_u *)&p_inex,
     PV_INEX,
     {(char_u *)"", (char_u *)0L}
    ...
    {"key",
     NULL,
     P_STRING | P_ALLOCED | P_VI_DEF | P_NO_MKRC,
#ifdef FEAT_CRYPT
     (char_u *)&p_key,
     PV_KEY,
     {(char_u *)"", (char_u *)0L}
    ...
    {"langmap",
     "lmap",
     P_STRING | P_VI_DEF | P_ONECOMMA | P_NODUP | P_SECURE,
#ifdef FEAT_LANGMAP
     (char_u *)&p_langmap,
     PV_NONE,
     {(char_u *)"", (char_u *)0L}
    ...
    {"maxmem",
     ...
     (char_u *)&p_mm,
     PV_NONE,
     {(char_u *)DFLT_MAXMEM, (char_u *)0L} SCTX_INIT},
    {"maxmempattern",
     "mmp",
     P_NUM | P_VI_DEF,
     (char_u *)&p_mmp,
    ...
    {"maxmemtot",
     ...
     (char_u *)&p_mmt,
     PV_NONE,
     {(char_u *)DFLT_MAXMEMTOT, (char_u *)0L} SCTX_INIT},
    {"menuitems",
     "mis",
     P_NUM | P_VI_DEF,
     (char_u *)NULL,
    ...
    {"mkspellmem",
     "msm",
     P_STRING | P_VI_DEF | P_EXPAND | P_SECURE,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"modeline",
    ...
    {"nrformats",
     ...
     (char_u *)&p_nf,
     PV_NF,
     {(char_u *)"bin,octal,hex", (char_u *)0L} SCTX_INIT},
    {"number",
     "nu",
     P_BOOL | P_VI_DEF | P_RWIN,
     (char_u *)VAR_WIN,
    ...
    {"packpath",
     "pp",
     P_STRING | P_VI_DEF | P_EXPAND | P_ONECOMMA | P_NODUP | P_SECURE,
     (char_u *)&p_pp,
     PV_NONE,
     {(char_u *)DFLT_RUNTIMEPATH, (char_u *)0L} SCTX_INIT},
    {"paragraphs",
     "para",
     P_STRING | P_VI_DEF,
     (char_u *)&p_para,
     PV_NONE,
     {(char_u *)"IPLPPPQPP TPHPLIPpLpItpplpipbp", (char_u *)0L} SCTX_INIT},
    {"paste",
     NULL,
     P_BOOL | P_VI_DEF | P_PRI_MKRC,
     (char_u *)&p_paste,
     PV_NONE,
     {(char_u *)FALSE, (char_u *)0L} SCTX_INIT},
    {"pastetoggle",
    ...
    {"path",
     "pa",
     P_STRING | P_EXPAND | P_VI_DEF | P_COMMA | P_NODUP,
     (char_u *)&p_path,
     PV_PATH,
     {
#if defined(MSWIN)
    ...
    {"previewwindow",
     "pvw",
     P_BOOL | P_VI_DEF | P_RSTAT | P_NOGLOB,
#if defined(FEAT_QUICKFIX)
     (char_u *)VAR_WIN,
     PV_PVW,
#else
    ...
    {"renderoptions",
     "rop",
     P_STRING | P_ONECOMMA | P_RCLR | P_VI_DEF,
    ...
    {"rightleftcmd",
     "rlc",
     P_STRING | P_ALLOCED | P_VI_DEF | P_RWIN,
#ifdef FEAT_RIGHTLEFT
     (char_u *)VAR_WIN,
     PV_RLC,
    ...
    {"ruler",
     "ru",
     P_BOOL | P_VI_DEF | P_VIM | P_RSTAT,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)FALSE, (char_u *)0L} SCTX_INIT},
    {"rulerformat",
     "ruf",
     P_STRING | P_VI_DEF | P_ALLOCED | P_RSTAT | P_MLE,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)"", (char_u *)0L} SCTX_INIT},
    {"runtimepath",
    ...
    {"scrollopt",
     ...
     (char_u *)&p_sbo,
     PV_NONE,
     {(char_u *)"ver,jump", (char_u *)0L} SCTX_INIT},
    {"sections",
     "sect",
     P_STRING | P_VI_DEF,
     (char_u *)&p_sections,
     PV_NONE,
     {(char_u *)"SHNHH HUnhsh", (char_u *)0L} SCTX_INIT},
    {"secure",
     NULL,
     P_BOOL | P_VI_DEF | P_SECURE,
     (char_u *)&p_secure,
    ...
    {"selection",
     ...
     (char_u *)&p_sel,
     PV_NONE,
     {(char_u *)"inclusive", (char_u *)0L} SCTX_INIT},
    {"selectmode",
     "slm",
     P_STRING | P_VI_DEF | P_ONECOMMA | P_NODUP,
     (char_u *)&p_slm,
    ...
    {"shortmess",
     "shm",
     P_STRING | P_VIM | P_FLAGLIST,
     (char_u *)&p_shm,
     PV_NONE,
     {(char_u *)"S", (char_u *)"filnxtToOS"} SCTX_INIT},
    {"shortname",
     "sn",
     P_BOOL | P_VI_DEF,
     (char_u *)&p_sn,
    ...
    {"spellcapcheck",
     "spc",
     P_STRING | P_ALLOCED | P_VI_DEF | P_RBUF,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"spellfile",
     "spf",
     P_STRING | P_EXPAND | P_ALLOCED | P_VI_DEF | P_SECURE | P_ONECOMMA,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"spelllang",
     "spl",
     P_STRING | P_ALLOCED | P_VI_DEF | P_ONECOMMA | P_RBUF | P_EXPAND,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"spellsuggest",
     "sps",
     P_STRING | P_VI_DEF | P_EXPAND | P_SECURE | P_ONECOMMA,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"splitbelow",
    ...
    {"suffixes",
     ...
     (char_u *)&p_su,
     PV_NONE,
     {(char_u *)".bak,~,.o,.h,.info,.swp,.obj", (char_u *)0L} SCTX_INIT},
    {"suffixesadd",
     "sua",
     P_STRING | P_VI_DEF | P_ALLOCED | P_ONECOMMA | P_NODUP,
#ifdef FEAT_SEARCHPATH
     (char_u *)&p_sua,
     PV_SUA,
     {(char_u *)"", (char_u *)0L}
    ...
    {"tabline",
     "tal",
     P_STRING | P_VI_DEF | P_RALL | P_MLE,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)"", (char_u *)0L} SCTX_INIT},
    {"tabpagemax",
    ...
    {"tags",
     "tag",
     P_STRING | P_EXPAND | P_VI_DEF | P_ONECOMMA | P_NODUP,
     (char_u *)&p_tags,
     PV_TAGS,
     {
    ...
    {"textauto",
     ...
     (char_u *)&p_ta,
     PV_NONE,
     {(char_u *)DFLT_TEXTAUTO, (char_u *)TRUE} SCTX_INIT},
    {"textmode",
     "tx",
     P_BOOL | P_VI_DEF | P_NO_MKRC,
     (char_u *)&p_tx,
    ...
    {"titleold",
     NULL,
     P_STRING | P_VI_DEF | P_GETTEXT | P_SECURE | P_NO_MKRC,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    {"titlestring",
    ...
    {"toolbar",
     "tb",
     P_STRING | P_ONECOMMA | P_VI_DEF | P_NODUP,
    ...
    {"ttyfast",
     "tf",
     P_BOOL | P_NO_MKRC | P_VI_DEF,
     (char_u *)&p_tf,
     PV_NONE,
     {(char_u *)FALSE, (char_u *)0L} SCTX_INIT},
    {"ttymouse",
     "ttym",
     P_STRING | P_NODEFAULT | P_NO_MKRC | P_VI_DEF,
     (char_u *)NULL,
     PV_NONE,
     {(char_u *)"", (char_u *)0L} SCTX_INIT},
    {"ttyscroll",
    ...
    {"undodir",
     "udir",
     P_STRING | P_EXPAND | P_ONECOMMA | P_NODUP | P_SECURE | P_VI_DEF,
#ifdef FEAT_PERSISTENT_UNDO
     (char_u *)&p_udir,
     PV_NONE,
     {(char_u *)".", (char_u *)0L}
    ...
    {"varsofttabstop",
     "vsts",
     P_STRING | P_VI_DEF | P_VIM | P_COMMA,
#ifdef FEAT_VARTABS
     (char_u *)&p_vsts,
     PV_VSTS,
     {(char_u *)"", (char_u *)0L}
    ...
    {"vartabstop",
     "vts",
     P_STRING | P_VI_DEF | P_VIM | P_RBUF | P_COMMA,
#ifdef FEAT_VARTABS
     (char_u *)&p_vts,
     PV_VTS,
     {(char_u *)"", (char_u *)0L}
    ...
    {"viminfo",
     "vi",
     P_STRING | P_ONECOMMA | P_NODUP | P_SECURE,
#ifdef FEAT_VIMINFO
     (char_u *)&p_viminfo,
     PV_NONE,
#if defined(MSWIN)
    ...
    {"whichwrap",
     "ww",
     P_STRING | P_VIM | P_ONECOMMA | P_FLAGLIST,
     (char_u *)&p_ww,
     PV_NONE,
    ...
    {"wildchar",
     ...
     (char_u *)&p_wc,
     PV_NONE,
     {(char_u *)(long)Ctrl_E, (char_u *)(long)TAB} SCTX_INIT},
    {"wildcharm",
     "wcm",
     P_NUM | P_VI_DEF,
     (char_u *)&p_wcm,
...
#define p_term(sss, vvv)                                                                           \
  {sss,                                                                                            \
   NULL,                                                                                           \
   P_STRING | P_VI_DEF | P_RALL | P_SECURE,                                                        \
   (char_u *)&vvv,                                                                                 \
   PV_NONE,                                                                                        \
   {(char_u *)"", (char_u *)0L} SCTX_INIT},

    p_term("t_AB", T_CAB) p_term("t_AF", T_CAF) p_term("t_AL", T_CAL) p_term("t_al", T_AL) p_term(
        "t_bc", T_BC) p_term("t_BE", T_BE) p_term("t_BD", T_BD) p_term("t_cd", T_CD)
        p_term("t_ce", T_CE) p_term("t_cl", T_CL) p_term("t_cm", T_CM) p_term("t_Ce", T_UCE) p_term(
            "t_Co", T_CCO) p_term("t_CS", T_CCS) p_term("t_Cs", T_UCS) p_term("t_cs", T_CS)
            p_term("t_CV", T_CSV) p_term("t_da", T_DA) p_term("t_db", T_DB) p_term(
                "t_DL", T_CDL) p_term("t_dl", T_DL) p_term("t_EC", T_CEC) p_term("t_EI", T_CEI)
                p_term("t_fs", T_FS) p_term("t_GP", T_CGP) p_term("t_IE", T_CIE) p_term(
                    "t_IS", T_CIS) p_term("t_ke", T_KE) p_term("t_ks", T_KS) p_term("t_le", T_LE)
                    p_term("t_mb", T_MB) p_term("t_md", T_MD) p_term("t_me", T_ME) p_term(
                        "t_mr", T_MR) p_term("t_ms", T_MS) p_term("t_nd", T_ND) p_term("t_op", T_OP)
                        p_term("t_RF", T_RFG) p_term("t_RB", T_RBG) p_term("t_RC", T_CRC) p_term(
                            "t_RI", T_CRI) p_term("t_Ri", T_SRI) p_term("t_RS", T_CRS)
                            p_term("t_RT", T_CRT) p_term("t_RV", T_CRV) p_term("t_Sb", T_CSB)
                                p_term("t_SC", T_CSC) p_term("t_se", T_SE) p_term("t_Sf", T_CSF)
                                    p_term("t_SH", T_CSH) p_term("t_SI", T_CSI) p_term(
                                        "t_Si", T_SSI) p_term("t_so", T_SO) p_term("t_SR", T_CSR)
                                        p_term("t_sr", T_SR) p_term("t_ST", T_CST) p_term(
                                            "t_Te", T_STE) p_term("t_te", T_TE) p_term("t_ti", T_TI)
                                            p_term("t_Ts", T_STS) p_term("t_ts", T_TS) p_term(
                                                "t_u7", T_U7) p_term("t_ue", T_UE)
                                                p_term("t_us", T_US) p_term("t_ut", T_UT) p_term(
                                                    "t"
                                                    "_"
                                                    "v"
                                                    "b",
                                                    T_VB) p_term("t_ve", T_VE) p_term("t_vi", T_VI)
                                                    p_term("t_VS", T_CVS) p_term("t_vs", T_VS)
                                                        p_term("t_WP", T_CWP) p_term("t_WS", T_CWS)
                                                            p_term("t_xn", T_XN) p_term("t_"
                                                                                        "x"
                                                                                        "s",
                                                                                        T_XS)
                                                                p_term("t_ZH", T_CZH)
...
static char *(p_buftype_values[]) = {"nofile",  "nowrite", "quickfix", "help", "terminal",
                                     "acwrite", "prompt",  "popup",    NULL};
...
static char *did_set_string_option(int opt_idx, char_u **varp, int new_value_alloced,
                                   char_u *oldval, char *errbuf, int opt_flags, int *value_checked);
...
#if defined(FEAT_POSTSCRIPT) &&                                                                    \
    (defined(MSWIN) || defined(VMS) || defined(EBCDIC) || defined(MAC) || defined(hpux))
...
#else
#ifdef VMS
                     (char_u *)"system('print/delete' . (&printdevice == '' ? '' : ' /queue=' "
                               ". &printdevice) . ' ' . v:fname_in)"

#else
                     (char_u *)"system('lpr' . (&printdevice == '' ? '' : ' -P' . &printdevice) "
...
void set_string_default(char *name, char_u *val) { set_string_default_esc(name, val, FALSE); }
...
static char_u *term_bg_default(void) {
  ...
  if (STRCMP(T_NAME, "linux") == 0 || STRCMP(T_NAME, "screen.linux") == 0 ||
      STRNCMP(T_NAME, "cygwin", 6) == 0 || STRNCMP(T_NAME, "putty", 5) == 0 ||
      ((p = mch_getenv((char_u *)"COLORFGBG")) != NULL && (p = vim_strrchr(p, ';')) != NULL &&
  ...
  if (p != NULL) {
    ...
    if (fnamecmp(p, "csh") == 0 || fnamecmp(p, "tcsh") == 0
      ...
      if (do_srr) {
        ...
        if (fnamecmp(p, "sh") == 0 || fnamecmp(p, "ksh") == 0 || fnamecmp(p, "mksh") == 0 ||
            fnamecmp(p, "pdksh") == 0 || fnamecmp(p, "zsh") == 0 || fnamecmp(p, "zsh-beta") == 0 ||
            fnamecmp(p, "bash") == 0 || fnamecmp(p, "fish") == 0
#ifdef MSWIN
            || fnamecmp(p, "cmd") == 0 || fnamecmp(p, "sh.exe") == 0 ||
            fnamecmp(p, "ksh.exe") == 0 || fnamecmp(p, "mksh.exe") == 0 ||
            fnamecmp(p, "pdksh.exe") == 0 || fnamecmp(p, "zsh.exe") == 0 ||
            fnamecmp(p, "zsh-beta.exe") == 0 || fnamecmp(p, "bash.exe") == 0 ||
  ...
  while (*arg != NUL) /* loop to process all options */
  {
    ...
    if (STRNCMP(arg, "all", 3) == 0 && !isalpha(arg[3]) && !(opt_flags & OPT_MODELINE)) {
      ...
      if (vim_strchr((char_u *)"?=:!&<", nextchar) != NULL) {
        ...
        if (vim_strchr((char_u *)"?!&<", nextchar) != NULL && arg[1] != NUL &&
            !VIM_ISWHITE(arg[1])) {
          errmsg = e_trailing;
          goto skip;
        }
       ...
       */
      if (nextchar == '?' ||
          (prefix == 1 && vim_strchr((char_u *)"=:&<", nextchar) == NULL && !(flags & P_BOOL))) {
        /*
         * print value
         */
        if (did_show)
        ...
        if (flags & P_BOOL) /* boolean */
        {
          ...
          if (nextchar == '!')
            ...
            value = (int)(long)(long_i)options[opt_idx]
                        .def_val[((flags & P_VI_DEF) || cp_val) ? VI_DEFAULT : VIM_DEFAULT];
          else if (nextchar == '<') {
        ...
        } else /* numeric or string */
        {
          ...
          if (flags & P_NUM) /* numeric */
          {
            ...
            ++arg;
            if (nextchar == '&')
              value = (long)(long_i)options[opt_idx]
                          .def_val[((flags & P_VI_DEF) || cp_val) ? VI_DEFAULT : VIM_DEFAULT];
            else if (nextchar == '<') {
              ...
              if ((long *)varp == &curbuf->b_p_ul && opt_flags == OPT_LOCAL)
                ...
                value = *(long *)get_varp_scope(&(options[opt_idx]), OPT_GLOBAL);
                       ...
                       (*arg == '<' || *arg == '^' ||
                        (*arg != NUL && (!arg[1] || VIM_ISWHITE(arg[1])) && !VIM_ISDIGIT(*arg)))) {
          ...
          } else if (opt_idx >= 0) /* string */
          {
            ...
            } else if (nextchar == '<') /* set to global val */
            {
              ...
              while (*arg && !VIM_ISWHITE(*arg)) {
                if (*arg == '\\' && arg[1] != NUL
#ifdef BACKSLASH_IN_FILENAME
                    && !((flags & P_EXPAND) && vim_isfilec(arg[1]) &&
              ...
              *s = NUL;
              ...
              if (adding || prepending) {
                ...
                if (adding) {
                  ...
                  if (comma && i > 1 && (flags & P_ONECOMMA) == P_ONECOMMA &&
                      origval[i - 1] == ',' && origval[i - 2] != '\\')
                    i--;
            ...
            *(char_u **)(varp) = newval;
...

            {
              ...
              errmsg = did_set_string_option(opt_idx, (char_u **)varp, new_value_alloced, oldval,
                                             errbuf, opt_flags, &value_checked);
 ...
 */
void set_string_option_direct_in_win(win_T *wp, char_u *name, int opt_idx, char_u *val,
 ...
 */
void set_string_option_direct_in_buf(buf_T *buf, char_u *name, int opt_idx, char_u *val,
                                     int opt_flags, int set_sid) {
 ...
 */
static char *set_string_option(int opt_idx, char_u *value,
...
#endif
    if ((r = did_set_string_option(opt_idx, varp, TRUE, oldval, NULL, opt_flags, &value_checked)) ==
        NULL)
 ...
 */
static int valid_name(char_u *val, char *allowed) {
  char_u *s;
 ...
 */
static int valid_filetype(char_u *val) { return valid_name(val, ".-_"); }

/*
 * Handle string options that need some action to perform when changed.
 * Returns NULL for success, or an error message for an error.
 */
static char *did_set_string_option(int opt_idx,           // index in options[] table
    ...
    if ((opt_flags & OPT_LOCAL) && *bkc == NUL)
      ...
      *flags = 0;
      ...
      if (opt_strings_flags(bkc, p_bkc_values, flags, TRUE) != OK)
        errmsg = e_invarg;
      if ((((int)*flags & BKC_AUTO) != 0) + (((int)*flags & BKC_YES) != 0) +
              (((int)*flags & BKC_NO) != 0) !=
          1) {
...
static char *set_chars_option(char_u **varp) {
  ...
  static struct charstab filltab[] = {
      {&fill_stl, "stl"},   {&fill_stlnc, "stlnc"}, {&fill_vert, "vert"},
      {&fill_fold, "fold"}, {&fill_diff, "diff"},
  };
  static struct charstab lcstab[] = {
      {&lcs_eol, "eol"},     {&lcs_ext, "extends"}, {&lcs_nbsp, "nbsp"},   {&lcs_prec, "precedes"},
      {&lcs_space, "space"}, {&lcs_tab2, "tab"},    {&lcs_trail, "trail"}, {NULL, "conceal"},
  };
  struct charstab *tab;
 ...
 * Returns NULL for success, or an error message for an error.
 */
static char *set_bool_option(int opt_idx,   /* index in options[] table */
                             char_u *varp,  /* pointer to the option variable */
                             int value,     /* new value */
                             int opt_flags) /* OPT_LOCAL and/or OPT_GLOBAL */
{
  ...
  *(int *)varp = value; /* set the new value */
  ...
  /* when 'modifiable' is changed, redraw the window title */
    ...
    if (curbuf->b_p_ma &&
        (term_in_normal_mode() ||
         (bt_terminal(curbuf) && curbuf->b_term != NULL && !term_is_finished(curbuf)))) {
      curbuf->b_p_ma = FALSE;
  ...
  /* when 'textauto' is set or reset also change 'fileformats' */
    ...
    set_string_option_direct((char_u *)"ffs", -1, p_ta ? (char_u *)DFLT_FFS_VIM : (char_u *)"",
 ...
 * Returns NULL for success, or an error message for an error.
 */
static char *set_num_option(int opt_idx,      /* index in options[] table */
                            char_u *varp,     /* pointer to the option variable */
 ...
 *		   unknown option: -3.
 */
int get_option_value(char_u *name, long *numval,
 ...
 */
int get_option_value_strict(char_u *name, long *numval,
  ...
  for (run = 1; run <= 2 && !got_int; ++run) {
    ...
    for (p = &options[0]; p->fullname != NULL; p++) {
      ...
      if (opt_flags != 0) {
        ...
        varp = get_varp(p);
      if (varp != NULL && ((all == 2 && isterm) || (all == 1 && !isterm) ||
 ...
 */
static void showoneopt(struct vimoption *p, int opt_flags) /* OPT_LOCAL or OPT_GLOBAL */
{
  char_u *varp;
...
static char_u *get_varp(struct vimoption *p) {
  ...
  case PV_SISO:
    return curwin->w_p_siso >= 0 ? (char_u *)&(curwin->w_p_siso) : p->var;
  case PV_SO:
    return curwin->w_p_so >= 0 ? (char_u *)&(curwin->w_p_so) : p->var;
#ifdef FEAT_FIND_ID
  case PV_DEF:
  ...
  case PV_MENC:
    return *curbuf->b_p_menc != NUL ? (char_u *)&(curbuf->b_p_menc) : p->var;
...
void buf_copy_options(buf_T *buf, int flags) {
  ...
  if (p_cpo != NULL) {
    ...
    if ((vim_strchr(p_cpo, CPO_BUFOPTGLOB) == NULL || !(flags & BCO_ENTER)) &&
        (buf->b_p_initialized || (!(flags & BCO_ENTER) && vim_strchr(p_cpo, CPO_BUFOPT) != NULL)))
      should_copy = FALSE;
 ...
 */
void set_iminsert_global(void) { p_iminsert = curbuf->b_p_iminsert; }

/*
 * Set the global value for 'imsearch' to the local value.
 */
void set_imsearch_global(void) { p_imsearch = curbuf->b_p_imsearch; }
...
void set_context_in_set_cmd(expand_T *xp, char_u *arg,
                            int opt_flags) /* OPT_GLOBAL and/or OPT_LOCAL */
{
  ...
  if (flags & P_EXPAND) {
    ...
    if (p == (char_u *)&p_bdir || p == (char_u *)&p_dir || p == (char_u *)&p_path ||
        p == (char_u *)&p_pp || p == (char_u *)&p_rtp
#ifdef FEAT_SEARCHPATH
        || p == (char_u *)&p_cdpath
#endif
#ifdef FEAT_SESSION
  ...
  *file = ALLOC_ONE(char_u *);
  ...
  for (var = buf; *var != NUL; MB_PTR_ADV(var))
    if (var[0] == '\\' && var[1] == '\\' && expand_option_idx >= 0 &&
        (options[expand_option_idx].flags & P_EXPAND) && vim_isfilec(var[2]) &&
        (var[2] != '\\' || (var == buf && var[4] != '\\')))
      STRMOVE(var, var + 1);
#endif
...
static void langmap_set_entry(int from, int to) {
  ...
  mch_memmove(entries + 1, entries, (langmap_mapga.ga_len - a) * sizeof(langmap_entry_T));
...
static void langmap_set(void) {
  ...
  for (p = p_langmap; p[0] != NUL;) {
    ...
    while (p[0]) {
      ...
      if (to == NUL) {
        semsg(_("E357: 'langmap': Matching character missing for %s"), transchar(from));
        return;
      }
...
int shortmess(int x) {
  return p_shm != NULL &&
         (vim_strchr(p_shm, x) != NULL ||
          (vim_strchr(p_shm, 'a') != NULL && vim_strchr((char_u *)SHM_A, x) != NULL));
}
    ...
    if (!old_p_paste) {
      ...
      FOR_ALL_BUFFERS(buf) {
        ...
        buf->b_p_vsts_nopaste =
            buf->b_p_vsts && buf->b_p_vsts != empty_option ? vim_strsave(buf->b_p_vsts) : NULL;
#endif
      }
 ...
 * Empty is always OK.
 */
static int check_opt_strings(char_u *val, char **values,
...
static int opt_strings_flags(char_u *val,               /* new value */
                             ...
                             unsigned *flagp, int list) /* when TRUE: accept a list of values */
{
  int i;
  int len;
 ...
 */
int can_bs(int what) /* BS_INDENT, BS_EOL or BS_START */
{
...
int file_ff_differs(buf_T *buf, int ignore_empty) {
  ...
  if (buf->b_flags & BF_NEVERLOADED)
    return FALSE;
  if (ignore_empty && (buf->b_flags & BF_NEW) && buf->b_ml.ml_line_count == 1 &&
 ...
 * to another.
 */
void tabstop_fromto(colnr_T start_col, colnr_T end_col, int ts_arg, int *vts, int *ntabs,
                    int *nspcs) {
 ...
 */
int tabstop_count(int *ts) { return ts != NULL ? ts[0] : 0; }

/*
 * Return the first tabstop, or 8 if there are no tabstops defined.
 */
int tabstop_first(int *ts) { return ts != NULL ? ts[1] : 8; }
 ...
 */
long get_sw_value(buf_T *buf) { return get_sw_value_col(buf, 0); }
 ...
 */
long get_sts_value(void) { return curbuf->b_p_sts < 0 ? get_sw_value(curbuf) : curbuf->b_p_sts; }

/*
 * Return the effective 'scrolloff' value for the current window, using the
 * global value when appropriate.
 */
long get_scrolloff_value(void) { return curwin->w_p_so < 0 ? p_so : curwin->w_p_so; }

/*
 * Return the effective 'sidescrolloff' value for the current window, using the
 * global value when appropriate.
 */
long get_sidescrolloff_value(void) { return curwin->w_p_siso < 0 ? p_siso : curwin->w_p_siso; }
