 ...
 */
int vim_strsize(char_u *s) { return vim_strnsize(s, (int)MAXCOL); }
 ...
 */
int linetabsize(char_u *s) { return linetabsize_col(0, s); }
 ...
 */
int vim_iswordc(int c) { return vim_iswordc_buf(c, curbuf); }
 ...
 */
int vim_iswordp(char_u *p) { return vim_iswordp_buf(p, curbuf); }
 ...
 */
int lbr_chartabsize(char_u *line UNUSED, /* start of the line */
                    unsigned char *s, colnr_T col) {
#ifdef FEAT_LINEBREAK
 ...
 */
int lbr_chartabsize_adv(char_u *line, /* start of the line */
                        char_u **s, colnr_T col) {
  int retval;
 ...
 */
int win_lbr_chartabsize(win_T *wp, char_u *line UNUSED, /* start of the line */
                        char_u *s, colnr_T col, int *headp UNUSED) {
#ifdef FEAT_LINEBREAK
  int c;
  int size;
  colnr_T col2;
  ...
  } else if (has_mbyte && size == 2 && MB_BYTE2LEN(*s) > 1 && wp->w_p_wrap &&
 ...
 */
int getwhitecols_curline() { return getwhitecols(ml_get_curline()); }

int getwhitecols(char_u *p) { return skipwhite(p) - p; }
 ...
 */
int vim_isdigit(int c) { return (c >= '0' && c <= '9'); }
 ...
 * characters > 0x100.
 */
int vim_isbdigit(int c) { return (c == '0' || c == '1'); }
...
static char_u latin1upper[257] =
    ...
    "\xd9\xda\xdb\xdc\xdd\xde\xdf\xc0\xc1\xc2\xc3\xc4\xc5\xc6\xc7\xc8\xc9\xca"
    "\xcb\xcc\xcd\xce\xcf\xd0\xd1\xd2\xd3\xd4\xd5\xd6\xf7\xd8\xd9\xda\xdb\xdc"
    "\xdd\xde\xff";
static char_u latin1lower[257] =
    ...
    "\x91\x92\x93\x94\x95\x96\x97\x98\x99\x9a\x9b\x9c\x9d\x9e\x9f\xa0\xa1\xa2"
    "\xa3\xa4\xa5\xa6\xa7\xa8\xa9\xaa\xab\xac\xad\xae\xaf\xb0\xb1\xb2\xb3\xb4"
    "\xb5\xb6\xb7\xb8\xb9\xba\xbb\xbc\xbd\xbe\xbf\xe0\xe1\xe2\xe3\xe4\xe5\xe6"
    "\xe7\xe8\xe9\xea\xeb\xec\xed\xee\xef\xf0\xf1\xf2\xf3\xf4\xf5\xf6\xd7\xf8"
    "\xf9\xfa\xfb\xfc\xfd\xfe\xdf\xe0\xe1\xe2\xe3\xe4\xe5\xe6\xe7\xe8\xe9\xea"
