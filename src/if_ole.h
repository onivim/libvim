...
typedef struct IVimVtbl {
  ...
  ULONG(STDMETHODCALLTYPE __RPC_FAR *AddRef)(IVim __RPC_FAR *This);

  ULONG(STDMETHODCALLTYPE __RPC_FAR *Release)(IVim __RPC_FAR *This);
  ...
  HRESULT(STDMETHODCALLTYPE __RPC_FAR *SetForeground)(IVim __RPC_FAR *This);
...
class DECLSPEC_UUID("0F0BFAE1-4C90-11d1-82D7-0004AC368519") Vim;
#endif
